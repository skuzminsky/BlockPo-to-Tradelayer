...
{ //  category                         name                          actor (function)             okSafeMode
  //  -------------------------------- ----------------------------- ---------------------------- ----------
    { "trade layer (raw transactions)", "tl_decodetransaction",     &tl_decodetransaction,     {} },
    { "trade layer (raw transactions)", "tl_createrawtx_opreturn",  &tl_createrawtx_opreturn,  {} },
    { "trade layer (raw transactions)", "tl_createrawtx_input",     &tl_createrawtx_input,     {} },
    { "trade layer (raw transactions)", "tl_createrawtx_reference", &tl_createrawtx_reference, {} },
    { "trade layer (raw transactions)", "tl_createrawtx_change",    &tl_createrawtx_change,    {} },
